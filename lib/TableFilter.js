      ...
      var filterField = this.props.columns.map(function (column) {
        ...
        return _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement('input', { type: 'text', placeholder: column.name, name: column.name, onKeyUp: this.handleKeyUp.bind(this), onChange: this.handleChange.bind(this) })
          )
        );
      }, this);
      return _react2['default'].createElement(
